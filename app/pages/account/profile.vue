<template>
  <ClientOnly>
    <section class="container mx-auto px-4 py-8">
      <h1 class="text-3xl font-bold mb-8 text-center text-secondary">Your Profile</h1>
      ...
      >
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div>
            <p class="text-gray-700 font-semibold">City:</p>
            <p class="text-secondary">
              {{ authStore.currentUser.city }}
            </p>
          </div>
          <div>
            <p class="text-gray-700 font-semibold">Postal Code:</p>
            <p class="text-secondary">
